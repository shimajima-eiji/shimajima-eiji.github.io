...
export default function Home(){
 ...
 function applyMove(input:Input){
  if(!recording.ready)throw Error('保存完了後に指してください。');
 ...
 useEffect(()=>{
  if(!busy||!recording.ready)return;
 ...
 },[version,mode,game,busy,recording.ready]);
 useEffect(()=>{
 ...
 function click(square:Square){
  if(!recording.ready||busy||game.isGameOver()||promotion)return;
